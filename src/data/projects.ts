...
export const projects: Project[] = ([
  ...
  },
  {
    ...
    statusVariant: "emerald",
    shortDescription:
      "Automation-first travel operations platform for African travel agencies and tour operators, connecting inquiries, CRM, bookings, travellers, payments, documents and trip-readiness workflows in one tenant-isolated system.",
    positioning: "Active development / hosted staging / pilot preparation.",
    valueProposition:
      "ExploreAfrica connects the agency journey from inquiry to trip readiness in one tenant-isolated platform, reducing fragmented operational work across CRM, bookings, travellers, payments, documents and customer communication.",
    overview:
      "ExploreAfrica is an automation-first Travel Operations Platform for African travel agencies and tour operators. It connects the operational journey from inquiry and lead management through customers, bookings, travellers, payments, documents and trip readiness within tenant-isolated agency workspaces. The current hosted staging system includes CRM workflows, customer and booking operations, traveller management, payment and reconciliation foundations, documents, trip-readiness workflows, a secure customer trip portal, tenant administration, staff invitations and multiple inquiry-integration paths.",
    problem:
      "Travel agencies often manage inquiries, customer information, bookings, traveller details, payments and documents across disconnected tools, spreadsheets, messaging channels and manual follow-up. That fragmentation makes it harder to maintain one reliable operational view from first inquiry through trip readiness.",
    solution:
      "ExploreAfrica brings the agency workflow into one tenant-isolated operations platform, connecting Inquiry → Lead → Opportunity → Customer → Booking → Travellers → Payments → Documents → Trip Ready while supporting staff access, customer self-service and external inquiry capture.",
    architecture:
      "The platform uses a multi-tenant application model with Supabase authentication, PostgreSQL Row Level Security, tenant-scoped roles and permissions, and protected agency and customer workflows. Public inquiry sources can connect through hosted forms, API or webhook integrations, while admin/staff and customer experiences remain separated by role and tenant boundaries.",
    capabilities: [
      "Multi-tenant agency workspaces",
      "Tenant-isolated PostgreSQL RLS",
      "Role and permission model",
      "Inquiry → Lead → Opportunity CRM flow",
      "Customers",
      "Bookings",
      "Travellers",
      "Payments and reconciliation foundation",
      "Documents",
      "Trip Ready readiness workflow",
      "Secure customer trip portal",
      "Tenant Admin",
      "Staff invitations",
      "Password recovery",
      "Brevo SMTP",
      "Lead Notifications",
      "Hosted Form inquiry integration",
      "API inquiry integration",
      "Webhook inquiry integration",
    ],
    technologies: [
      "Next.js",
      "React",
    ...
    currentStatusHeading: "Current status: Active development / hosted staging / pilot preparation",
    currentStatus:
      "Core agency, CRM, booking, traveller, payment-foundation, document and trip-readiness workflows are implemented across hosted staging environments. Onboarding and go-live preparation are still being finalized. ExploreAfrica is actively developed and pilot-stage; it should not be described as production-ready.",
    roadmap:
      "The next major payments milestone is Payments V2, including M-Pesa integration and further payment/reconciliation automation.",
    claimsNotToMake: [
      "Not production-ready",
      "No full commercial rollout claim",
      "No paying-agency claim",
      "No customer-adoption metric claim",
      "No revenue-impact claim",
      "M-Pesa is planned, not implemented",
      "Payments V2 is planned, not complete",
      "Not every planned feature is complete",
    ],
    links: [
      {
      ...
      {
        url: "https://exploreafrica-admin-staging-preview.vercel.app",
        label: "Admin Portal",
        kind: "website",
      },
      {
        url: "https://exploreafrica-customer-staging.benjamin-kamau.workers.dev",
        label: "Customer Trip Portal",
        kind: "website",
      },
      {
        url: "https://github.com/kamaubenjamin/TravellingVacationPackagesWebsite",
        label: "GitHub",
        kind: "repository",
      },
    ],
  ...
  },
  {
    ...
    category: "Gym Operations & Member Management Platform",
    status: "Live Pilot",
    statusVariant: "lime",
    shortDescription:
    ...
    solutionDetails: [
      ...
      "PostgreSQL RLS/privacy boundaries with member-only access to own records",
    ],
    caseStudySections: [
      {
      ...
      },
      {
        ...
        details: [
          "Member management, Member Applications, membership plans, session packages and Start Membership",
          "Staff/admin controlled Time In and Time Out attendance with authoritative session entitlement rules",
          "Locker assignment, release and occupied/available workflow tied to attendance/check-in operations",
          "Classes, trainers, inventory and announcements for day-to-day operations",
        ],
      },
      {
        title: "Engineering Quality & Pilot-Safe Iteration",
        description:
          "The hosted pilot is supported by migration discipline, live-data backup procedures, integrity checks and isolated QA data so the system can evolve while real workflows are validated.",
        details: [
      ...
      },
      {
        ...
        details: [
          ...
          "No multiple-gym adoption, revenue, impact metrics or commercial-scale claims are made",
        ],
      },
    ],
    architecture:
      "GymBolt uses a React/TypeScript/Vite frontend on Cloudflare Pages with Supabase Auth, PostgreSQL, RLS and PostgreSQL RPCs enforcing role-aware operational boundaries.",
    architectureDetails: [
      "Admin, Staff and Member roles have separated navigation, permissions and record visibility",
      "Transactional/RPC-backed operations are used where authoritative membership, payment and entitlement transitions require consistency",
      "Backups, migration replay/validation and integrity checks support controlled hosted changes during the active pilot",
    ],
    capabilities: [
    ...
    paymentWorkflow:
      "Invoice creation is not entitlement. GymBolt requires authoritative exact payment settlement before subscription activation, renewal or future membership transition changes are applied.",
    paymentWorkflowDetails: [
      "Invoice created to exact payment recorded/settled to receipt persisted to membership transition evaluated",
      "Authoritative invoice/payment state prevents entitlement changes based only on invoice creation",
      "Session consumption and remaining-session tracking follow governed entitlement rules",
    ],
    technologies: [
      "React",
      "TypeScript",
    ...
    verifiedOutcomes: [
      "Functional live pilot currently being validated with Lock & Load Gym",
      "Hosted Admin, Staff and Member experiences backed by Supabase Auth and PostgreSQL/RLS",
      "Pilot-safe iteration supported by backups, migration validation, integrity checks and isolated QA records",
    ],
    ...
    roadmap:
      "Current priority is active pilot validation and production-safe iteration with Lock & Load Gym.",
    roadmapDetails: [
      "Continue validating real membership, attendance, billing, locker and member-portal workflows",
      "Maintain backup, migration replay/validation and data-integrity discipline during hosted changes",
      "Future opportunities such as production M-Pesa, QR attendance, hardware integrations or multi-gym rollout are not presented as implemented",
    ],
    role:
      "I designed the system architecture, modelled the operational workflows and built the responsive Admin, Staff and Member experiences for the live pilot.",
    roleDetails: [
      "Implemented membership, billing, attendance, session entitlement, locker and cashbook rules",
      "Designed privacy and authorization boundaries with Supabase Auth, PostgreSQL and RLS",
      "Built secure member self-service visibility across membership, sessions, visits, billing and profile data",
      "Managed migrations, hosted validation, backups, QA isolation and pilot-safe iteration",
    ],
    callToAction:
      "Need a role-based operations platform with governed billing, secure member self-service and pilot-safe delivery? Let's discuss a similar project.",
    liveDemoStatus: "https://gymbolt-lock-load-gym.pages.dev",
    repositoryStatus: "Private Repository",
    links: [
      {
        url: "https://gymbolt-lock-load-gym.pages.dev",
        label: "View Live Pilot",
        kind: "preview",
        primary: true,
      },
    ],
