        ...
        <div className="hero-grid grid gap-10 xl:grid-cols-12 xl:items-center xl:gap-14">
          ...
          <div className="hero-content xl:col-span-6">
            <div className="hero-primary">
              <p className="mb-4 text-xs font-semibold uppercase tracking-[0.26em] text-[var(--color-mint-muted)]">
              ...
              <div className="hero-actions mb-8 flex flex-col gap-2.5 sm:flex-row sm:flex-wrap">
                ...
                <div className="mt-4 flex items-center gap-2">
                  {social.github && (
                    <a
                      ...
                      className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-[var(--radius-button)] p-2 text-[var(--color-text-muted)] transition-colors hover:text-[var(--color-emerald)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-emerald)]"
                      aria-label="GitHub"
                    >
          ...
          <div className="hero-visual min-w-0 w-full xl:col-span-6">
            <DataFlowVisual />
          </div>
        </div>
      </Container>
